...
const SLEEP_INTERVALS = {
  NIGHT: 210, // 2 часа 40 минут = 180 минут (после ночного сна)
  MORNING: 210, // 2 часа 40 минут = 180 минут (после утреннего)
  AFTERNOON: 240, // 2 часа 40 минут = 160 минут (после обеда)
};
